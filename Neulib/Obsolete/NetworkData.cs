...
namespace Neulib.NeuronsNew
{
    public class NetworkData
    {
        ...
        public LayerData First { get; private set; }

        public LayerData Last
        {
            get
            {
                LayerData layer = First;
        ...
        public void Append(LayerData layer)
        {
            layer.Parent = this;
            if (First == null)
            {
        ...
        protected void ForEach(Action<LayerData> action, bool skipFirst)
        {
            LayerData layer = First;
        ...
        private void SetCoefficients(float[] p)
        {
            ...
            ForEach(layer =>
            {
                layer.ForEach((NeuronData neuron) =>
                {
                    neuron.Bias = p[h++];
        ...
        private void AddDerivatives(float[] dC)
        {
            ...
            ForEach(layer =>
            {
                LayerData prevLayer = layer.Previous;
